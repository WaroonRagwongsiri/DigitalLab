        ...
        IF falling_edge(CLK_1MHz) THEN
            ...
            ELSE
                CASE STATE IS
                    ...
                    WHEN WAIT_NULL =>
                        INT_MOSI <= '0';
                        -- MCP3208 needs exactly 1 null-bit clock; a 2nd cycle
                        -- here compensates for MISO_REG's 1-cycle registration
                        -- delay (verified in simulation: COUNTER=2, i.e. 3
                        -- cycles, silently doubled every ADC reading).
                        IF COUNTER = 1 THEN
                            COUNTER <= 0;
                            STATE <= RECEIVE_BIT;
                        ELSE
