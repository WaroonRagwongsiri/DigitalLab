...
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { carry_in }];
set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports { rhs }];
set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { lhs }];#MSB
...
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { carry_out }];
set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { sum }];#MSB
